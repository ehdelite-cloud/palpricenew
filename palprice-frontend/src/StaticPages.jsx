  ...
  const sections = [
    {
      ...
      content: lang === "ar"
        ? "نجمع المعلومات التي تقدمها عند التسجيل مثل الاسم والبريد الإلكتروني. كذلك نجمع بيانات الاستخدام مثل المنتجات التي تشاهدها وتفضلها لتحسين تجربتك."
        : "We collect information you provide during registration such as name and email. We also collect usage data like products you view and favorite to improve your experience."
    },
    {
      title: lang === "ar" ? "كيف نستخدم معلوماتك" : "How We Use Your Information",
      content: lang === "ar"
        ? "نستخدم معلوماتك لتخصيص تجربتك، إرسال تنبيهات الأسعار التي طلبتها، وتحسين خدماتنا. لا نبيع معلوماتك لأي طرف ثالث."
        : "We use your information to personalize your experience, send price alerts you requested, and improve our services. We never sell your information to third parties."
    },
    {
      title: lang === "ar" ? "الكوكيز" : "Cookies",
      content: lang === "ar"
        ? "نستخدم الكوكيز لحفظ تفضيلاتك وإبقائك مسجل الدخول. يمكنك تعطيل الكوكيز من إعدادات متصفحك، لكن بعض الميزات قد لا تعمل بشكل صحيح."
        : "We use cookies to save your preferences and keep you logged in. You can disable cookies in your browser settings, but some features may not work properly."
    },
    {
      title: lang === "ar" ? "أمان بياناتك" : "Data Security",
      content: lang === "ar"
        ? "نحمي بياناتك باستخدام تشفير SSL وأفضل الممارسات الأمنية. كلمات المرور مشفّرة ولا يمكن لأحد الاطلاع عليها بما فيهم فريقنا."
        : "We protect your data using SSL encryption and best security practices. Passwords are encrypted and no one can access them, including our team."
    },
    {
      title: lang === "ar" ? "حقوقك" : "Your Rights",
      content: lang === "ar"
        ? "يحق لك الوصول لبياناتك، تعديلها، أو حذفها في أي وقت من صفحة الملف الشخصي. للاستفسار تواصل معنا عبر صفحة التواصل."
        : "You have the right to access, modify, or delete your data at any time from the profile page. For inquiries, contact us through the contact page."
    },
  ];
      ...
      <div style={{ maxWidth: "760px", margin: "48px auto", padding: "0 24px 64px" }}>
        ...
        <div style={{ background: "#f0fdf4", borderRadius: "14px", padding: "20px 24px", border: "1px solid #bbf7d0", textAlign: "center" }}>
          <p style={{ fontSize: "14px", color: "#166534", margin: 0 }}>
            ...
            <Link to="/contact" style={{ color: "#16a34a", fontWeight: "700" }}>
...
export function FAQPage({ lang = "ar" }) {
  const faqs = [
    {
      q: lang === "ar" ? "هل PalPrice مجاني؟" : "Is PalPrice free?",
      a: lang === "ar" ? "نعم! PalPrice مجاني تماماً للمستهلكين. يمكنك مقارنة الأسعار وإضافة المفضلة وإنشاء تنبيهات الأسعار بدون أي رسوم." : "Yes! PalPrice is completely free for consumers. Compare prices, add favorites, and create price alerts at no cost."
    },
    {
      q: lang === "ar" ? "كيف أضيف منتجاً للمقارنة؟" : "How do I add a product to compare?",
      a: lang === "ar" ? "افتح صفحة أي منتج واضغط على زر \"مقارنة\". يمكنك إضافة حتى 4 منتجات من نفس الفئة ومقارنة أسعارها ومواصفاتها." : "Open any product page and click the \"Compare\" button. You can add up to 4 products from the same category and compare their prices and specs."
    },
    {
      q: lang === "ar" ? "كيف تعمل تنبيهات السعر؟" : "How do price alerts work?",
      a: lang === "ar" ? "في صفحة أي منتج، أدخل بريدك الإلكتروني والسعر المستهدف. عندما ينخفض السعر لهذا الحد سترسل لك رسالة إلكترونية تلقائياً." : "On any product page, enter your email and target price. When the price drops to that level, you'll receive an automatic email notification."
    },
    {
      q: lang === "ar" ? "هل الأسعار محدّثة؟" : "Are prices up to date?",
      a: lang === "ar" ? "نعم، التجار يحدّثون أسعارهم باستمرار من خلال لوحة التحكم الخاصة بهم. نوصي دائماً بالتحقق من السعر مباشرة في موقع المتجر قبل الشراء." : "Yes, merchants continuously update their prices through their dashboard. We always recommend verifying the price directly on the store's website before purchasing."
    },
    {
      q: lang === "ar" ? "كيف أسجّل متجري؟" : "How do I register my store?",
      a: lang === "ar" ? "اضغط على \"سجّل متجرك\" من القائمة العلوية. أنشئ حساباً للمتجر وأضف منتجاتك. ستراجع الإدارة طلبك وتوافق عليه خلال 24 ساعة." : "Click \"Register Store\" from the top menu. Create a store account and add your products. The admin will review and approve your request within 24 hours."
    },
    {
      q: lang === "ar" ? "هل يمكنني الشراء مباشرة من PalPrice؟" : "Can I buy directly from PalPrice?",
      a: lang === "ar" ? "لا، PalPrice هو موقع مقارنة أسعار فقط. نعرض لك الأسعار من المتاجر المختلفة وعليك الشراء مباشرة من المتجر الذي اخترته." : "No, PalPrice is a price comparison site only. We show you prices from different stores and you purchase directly from your chosen store."
    },
  ];
        ...
        {faqs.map((faq, i) => (
          <div key={i} style={{ background: "white", borderRadius: "14px", marginBottom: "10px", border: `1.5px solid ${open === i ? "#22c55e" : "#e2e8f0"}`, overflow: "hidden", transition: "border-color 0.2s" }}>
            <button onClick={() => setOpen(open === i ? null : i)}
              style={{ width: "100%", padding: "18px 22px", background: "none", border: "none", textAlign: "right", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "12px", fontFamily: "Tajawal, sans-serif" }}>
              <span style={{ fontSize: "15px", fontWeight: "700", color: open === i ? "#16a34a" : "#0f172a" }}>{faq.q}</span>
  ...
  return (
    <div>
      ...
      <div style={{ background: "linear-gradient(160deg, #0f172a 0%, #0d3320 100%)", padding: "80px 24px 64px", textAlign: "center", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: "700px", margin: "auto" }}>
          ...
          <div style={{ display: "flex", gap: "12px", justifyContent: "center", flexWrap: "wrap" }}>
            <Link to="/store/register" style={{ padding: "14px 32px", background: "linear-gradient(135deg, #22c55e, #16a34a)", color: "white", borderRadius: "12px", textDecoration: "none", fontSize: "15px", fontWeight: "700", boxShadow: "0 4px 20px rgba(34,197,94,0.35)" }}>
              {lang === "ar" ? "🚀 سجّل متجرك الآن" : "🚀 Register Now — Free"}
            </Link>
            <Link to="/store/login" style={{ padding: "14px 28px", background: "rgba(255,255,255,0.08)", color: "white", borderRadius: "12px", textDecoration: "none", fontSize: "15px", fontWeight: "600", border: "1px solid rgba(255,255,255,0.15)" }}>
      ...
      <div style={{ maxWidth: "900px", margin: "64px auto", padding: "0 24px" }}>
        <h2 style={{ fontSize: "26px", fontWeight: "800", color: "#0f172a", textAlign: "center", marginBottom: "36px", fontFamily: "Cairo, Tajawal, sans-serif" }}>
      ...
      <div style={{ background: "linear-gradient(135deg, #0f172a, #1e293b)", padding: "56px 24px", textAlign: "center" }}>
        <h2 style={{ fontSize: "24px", fontWeight: "800", color: "white", marginBottom: "10px", fontFamily: "Cairo, Tajawal, sans-serif" }}>
        ...
        <Link to="/store/register" style={{ padding: "13px 32px", background: "linear-gradient(135deg, #22c55e, #16a34a)", color: "white", borderRadius: "12px", textDecoration: "none", fontSize: "15px", fontWeight: "700", boxShadow: "0 4px 16px rgba(34,197,94,0.3)" }}>
...
export function HowItWorksPage({ lang = "ar" }) {
  const forUsers = [
    ...
    { icon: "🏆", title: lang === "ar" ? "اختر الأفضل" : "Choose the Best", desc: lang === "ar" ? "اختر أفضل سعر واشتري من المتجر مباشرة" : "Choose the best price and buy from the store directly" },
  ];
    ...
    <div>
      ...
      <div style={{ maxWidth: "1000px", margin: "auto", padding: "48px 24px 64px" }}>
        ...
        <div style={{ marginBottom: "56px" }}>
          <h2 style={{ fontSize: "22px", fontWeight: "800", color: "#0f172a", marginBottom: "24px", display: "flex", alignItems: "center", gap: "10px", fontFamily: "Cairo, Tajawal, sans-serif" }}>
        ...
        {/* المميزات */}
        <h2 style={{ fontSize: "22px", fontWeight: "800", color: "#0f172a", marginBottom: "24px", fontFamily: "Cairo, Tajawal, sans-serif" }}>
